...
def main():
    ...
    additional_meshes = np.concatenate([temp_vertices_index, sculptor_faces[:, 2:]], axis=1)
    ...
    sculptor_mesh = trimesh.Trimesh(sculptor_vertices, sculptor_faces, vertex_colors=sculptor_color, process=False)
    ...
    sculptor_bounding_box = sculptor_mesh.bounding_box
    sculptor_bounding_box.export("./testing/sculptor_bounding_box.ply")
    sculptor_mesh.export("./testing/sculptor_mesh.ply")
